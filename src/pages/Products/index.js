            ...
            return (
              ...
              <div className="card product">
                ...
                <div className="card-body">
                  ...
                  <p className="cart_item_text">{product.description}</p>
                  <div className="bottom">
                    <p className="card-text-price"><small className="text-muted"> {product.price} € / un</small></p>
                    <button onClick={addMeToCart(product)} className="btn btn-warning btn-lg" type="submit"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
