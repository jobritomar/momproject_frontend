                                        ...
                                        props.products.map((product) => <li className="cart_item clearfix">
                                            ...
                                            <div className="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                                ...
                                                <div className="cart_item_quantity cart_info_col">
                                                    ...
                                                    <button onClick={handleDelete(product._id)} className="btn btn-primary btn-lg delete" type="submit"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" class="bi bi-trash3" viewBox="0 0 16 16">
